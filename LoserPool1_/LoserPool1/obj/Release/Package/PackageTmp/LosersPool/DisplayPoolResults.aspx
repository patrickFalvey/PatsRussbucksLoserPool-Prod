<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="DisplayPoolResults.aspx.vb" Inherits="LoserPool1.DisplayPoolResults" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">

    <h2><%:CStr(ViewState("weekNumber")) + "   Final Results"%></h2>
